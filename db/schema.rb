...
ActiveRecord::Schema.define(version: 2020_12_02_184829) do
  ...
  create_table "following_relationships", force: :cascade do |t|
    ...
    t.index ["followed_user_id"], name: "index_create_following_relationships_on_followed_user_id"
    t.index ["follower_id"], name: "index_create_following_relationships_on_follower_id"
  end
